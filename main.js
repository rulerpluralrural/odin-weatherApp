...
const ui = (() => {
	...
	function formatDate(date) {
		const newDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(date, "MMMM/dd/yyyy");
		return newDate;
	}
