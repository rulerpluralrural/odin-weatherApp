...
const ui = (() => {
	...
	function formatDate(date) {
		const newDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(date, "MMM dd,yyyy");
		return newDate;
	}

	function getTime(date) {
		const newTime = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(date, "hh:mm a");
		return newTime;
	}
...
const weather = (() => {
	async function getData(location) {
		try {
			...
			alert(error);
			_UI__WEBPACK_IMPORTED_MODULE_0__["default"].appError()
		}
	}
	return { getData };
})();
...
searchWeather.addEventListener("submit", async (e) => {
	...
	_Modules_UI__WEBPACK_IMPORTED_MODULE_1__["default"].viewApp(weatherData);
});
